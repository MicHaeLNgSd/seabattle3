class Board {
    ...
    constructor(gridEl, isComputerBoard, userShipsEl, userShipsEls, onPlayerGoFunc) {
        this.gridEl = gridEl
        this.#isComputerBoard = isComputerBoard
        this.#userShipsEl = userShipsEl
        this.userShipsEls = userShipsEls
        this.onPlayerGoFunc = onPlayerGoFunc
    }
    ...
    clean() {
        ...
        if (!this.#isComputerBoard) {
            for (let i = 1; i <= Board.SHIPS_COUNT; i++) {
                ...
                section.append(this.#shipElementByNumber(i))
            }
